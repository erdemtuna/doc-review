...
export function readmeCover(image) {
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .preview { position: absolute; left: 455px; top: 48px; width: 930px; height: 635px; border: 1px solid ${palette.border}; border-radius: 16px; overflow: hidden; background: ${palette.card}; box-shadow: 0 20px 60px ${palette["review-shadow-color"]}; }
