...
try {
  ...
  const html = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>React shell migration review</title><style>
    ...
    <section><h2><a href="${emptyUrl}">3. Empty states</a></h2><p>No comments, edits or rounds. Inspect Comments, disabled Send and empty Changes before adding the first comment.</p></section>
